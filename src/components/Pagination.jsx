...
class Pagination extends React.Component {
    ...
    componentDidUpdate() {
        if (this.props.currentPage !== this.state.currentPage) {
            ...
            if (currentPage === 1) {
                ...
                this.setState({ currentPage, startPage: this.props.pages - 5, endPage: this.props.pages })
            } else {
    ...
    selectPage = (event) => {
        ...
        if(currentPage === 1) {
            ...
            this.setState({ startPage: this.props.pages - 5, endPage: this.props.pages })
        }
    }
    ...
    selectLastPageInRange = (event) => {
        ...
        const endPage = startPage + 5 <= this.props.pages ? startPage + 5 : this.props.pages;
        this.setState({ startPage, endPage })
    }
    ...
    render () {
        ...
        if (endPage !== pages) {
            lis.push(<li>...</li>);
            lis.push(<li className={pages === currentPage ? "active" : "waves-effect"}><a href="#" onClick={this.selectPage}>{pages}</a></li>);
        }
